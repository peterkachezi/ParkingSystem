...
namespace ParkingManager.Services.SMSModule
{
    public class MessagingService : IMessagingService
    {
        ...
        public async Task<AppointmentDTO> ApprovalNotificationSMS(AppointmentDTO appointmentDTO)
        {
            try
            {
                ...
                var txtMessage = "Dear  " +
                    ...
                    "For more information you can contact us on: +254 792 111 222.";
        ...
        public async Task<AppointmentDTO> AppointmentBookingNotificationSMS(AppointmentDTO appointmentDTO)
        {
            try
            {
                var url = "http://167.172.14.50:4002/v1/send-sms";
                ...
                var txtMessage = "Dear  " +
                    ...
                    appointmentDTO.TimeSlot + " , was successfully booked, you will receive a notification once approved. " +
        ...
        public async Task<List<AppointmentDTO>> AppointmentNotificationSMSAsync(List<AppointmentDTO> appointmentDTO)
        {
            try
            {
                var url = "http://167.172.14.50:4002/v1/send-sms";
                ...
                {
                    var txtMessage = "Hey " + item.FirstName + ", this is a friendly reminder for your upcoming appointment on " +

                    "" + item.NewAppDate + " " +

                    " from " + item.TimeSlot + "  at Fertility Point" +               
                    ...
                    var msisdn = formatPhoneNumber(item.PhoneNumber);
